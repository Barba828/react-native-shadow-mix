...
export default class AndroidShadow extends Component {
  render = () => {
    //获取参数并定义默认值
    const {
      width = 0,
    ...
    //保证圆角不超过长宽
    const radius =
      this.props.radius && this.props.radius !== 0
        ? this.props.radius * 2 < width && this.props.radius * 2 < height
          ? this.props.radius
